	...
	"gap-2 group-has-[[data-slot=item-description]]/item:translate-y-0.5 group-has-[[data-slot=item-description]]/item:self-start flex shrink-0 items-center justify-center [&_svg]:pointer-events-none",
	{
		variants: {
			variant: {
				...
				image:
					"size-8 overflow-hidden rounded-md bg-muted group-data-[size=sm]/item:size-8 group-data-[size=xs]/item:size-6 [&_img]:size-full [&_img]:object-cover",
			},
		},
		defaultVariants: {
			variant: "default",
...
function ItemDescription({
	...
	truncate = true,
	...props
}: React.ComponentProps<"p"> & { truncate?: boolean }) {
	return (
		<p
			data-slot="item-description"
			className={cn(
				"text-muted-foreground text-left text-xs/relaxed [&>a:hover]:text-primary font-normal [&>a]:underline [&>a]:underline-offset-4",
